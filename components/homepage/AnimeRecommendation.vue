<template>
  <section id="latest-anime-recommendations">
    <section id="anime-recom-header" class="w-full flex items-center justify-between gap-2 pb-1 border-b border-mal-lightdark">
    ...
    <section id="anime-recom-container" class="w-full flex flex-col">
      <article v-for="(anime, index) in animeData" class="w-full py-2 flex flex-col gap-1 border-b border-mal-lightdark">
            ...
            <div class="flex flex-1 gap-1 items-start mt-1">
              ...
              <div>
                <nuxt-link 
                  ...
                  target="_blank"
                  class="w-max text-sm font-bold text-mal-blue hover:text-mal-lightblue hover:underline underline-offset-1 
                  transition-colors"
                >
                  {{ anime.entry[0].title }}
                </nuxt-link>
...
export default {
  ...
  setup(props) {
    ...
    return {
      animeData, isClamped, recomContent
    }
  }
}
</script>